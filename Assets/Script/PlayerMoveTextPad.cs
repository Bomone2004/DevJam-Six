...
public class PlayerMoveTextPad : MonoBehaviour
{
    ...
    private void DoExplosion()
    {
        ...
        {
            BallrigidBody.AddExplosionForce(explosionForce, ExplosionPosition1.transform.position, explosionRange, 0, ForceMode.VelocityChange);
        }
        ...
        {
            BallrigidBody.AddExplosionForce(explosionForce, ExplosionPosition2.transform.position, explosionRange, 0, ForceMode.VelocityChange);
        }
    }
